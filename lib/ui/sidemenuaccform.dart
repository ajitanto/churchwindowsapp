...
class SideMenuaccform extends StatefulWidget {
  String userid;
  String yearcycle;

  SideMenuaccform(this.userid,this.yearcycle);

  @override
  SideMenuaccformState createState() => SideMenuaccformState();
}

class SideMenuaccformState extends State<SideMenuaccform> {
  ...
  Widget build(BuildContext context) {
   ...
   Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => RentLedgerUser(userid: widget.userid,yearcycle: widget.yearcycle)),
  );
                 }),     DrawerListTile(
            title: "Home",
            icon: Icons.home,
