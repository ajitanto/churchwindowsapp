...
final String? yearcycle;
   DeactiveUser({Key? key,this.userid,this.formtype,this.yearcycle}) : super(key: key);
...
setState(() {
 ...
 void createcerti(BuildContext context,Addrent _addrent){
   setState(() {
    ...
    DBProvider.db.deactivate(_addrent ).then((value) {
     if(value=="Success"){
      setState(() {
        _isLoading=false; 
       _isbutton=true;
 ...
 return             CoolAlert.show(
  ...
  Widget build(BuildContext context) {
    ...
    final Size _size = MediaQuery.of(context).size;
     ...
     Text("Deactivate User",style: TextStyle(fontSize: 25),),
