...
class MarriageForm3 extends StatefulWidget {
final String? formtype;
   MarriageForm3({Key? key,this.formtype}) : super(key: key);

  @override
  State<MarriageForm3> createState() => _MarriageForm3State();
}

class _MarriageForm3State extends State<MarriageForm3> {
...
formatted = formatter.format(now);
 ...
 void createcerti(BuildContext context,Marriage3 _marriage){
  setState(() {
    ...
    Createcertificate.createMarriage3(context,_marriage ).then((value) {
     if(value=="Success"){
      setState(() {
 ...
 _datemarriageController.text = "";
  ...
  Widget build(BuildContext context) {
    ...
    final Size _size = MediaQuery.of(context).size;
     ...
     Text("Marriage Form III",style: TextStyle(fontSize: 25),),
...
LayoutBuilder(
 ...
 ResponsiveGridList(
  ...
  TextFormField(
                   decoration: const InputDecoration( 
               //icon of text field
                   labelText: "Number of Banns to be dispensed" //label text of field
                ),
                    onFieldSubmitted: (value) {
                      setState(() {
                     marriage.noofbanns = value;
                        // firstNameList.add(firstName);
                      });
                    },
                    ...
                    validator: (value) {
                     if (value == null || value.isEmpty) {
      return "Enter Number of Banns to be dispensed";
    }
    else{
      setState(() {
marriage.noofbanns=value;
