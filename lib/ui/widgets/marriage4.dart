...
class MarriageForm4 extends StatefulWidget {
final String? formtype;
   MarriageForm4({Key? key,this.formtype}) : super(key: key);

  @override
  State<MarriageForm4> createState() => _MarriageForm4State();
}

class _MarriageForm4State extends State<MarriageForm4> {
...
formatted = formatter.format(now);
 ...
 void createcerti(BuildContext context,Marriage4 _marriage){
    ...
    Createcertificate.createMarriage4(context,_marriage ).then((value) {
     if(value=="Success"){
      setState(() {
 ...
 _datemarriageController.text = "";
  ...
  Widget build(BuildContext context) {
    ...
    final Size _size = MediaQuery.of(context).size;
     ...
     Text("Marriage Form IV",style: TextStyle(fontSize: 25),),
     Text("i.	 Petition for permission for Marriage of a catholic with a baptised non-catholic",style: TextStyle(fontSize: 20),),
     Text("ii. Petition for dispensation for Marriage of a catholic with a non-baptised person",style: TextStyle(fontSize: 20),),
