...
class MarriageForm5 extends StatefulWidget {
final String? formtype;
   MarriageForm5({Key? key,this.formtype}) : super(key: key);

  @override
  State<MarriageForm5> createState() => _MarriageForm5State();
}

class _MarriageForm5State extends State<MarriageForm5> {
...
formatted = formatter.format(now);
 ...
 void createcerti(BuildContext context,Marriage4 _marriage){
    ...
    Createcertificate.createMarriage5(context,_marriage ).then((value) {
     if(value=="Success"){
      setState(() {
 ...
 _datemarriageController.text = "";
  ...
  Widget build(BuildContext context) {
    ...
    final Size _size = MediaQuery.of(context).size;
     ...
     Text("Marriage Form V",style: TextStyle(fontSize: 25),),
     Text("Petition for Dispensation from Impediments",style: TextStyle(fontSize: 20),),
